...
export class TransferImage {
  ...
  tempTOUploadFolder() {
    ...
    const TEMP_FOLDER_PATH = path.join(__dirname, '..', '..', '..', 'public', 'temp', this.id,this.type, this.name)
...
// const singletonInstance = TransferImage.getInstance();

// console.log(singletonInstance.getData()); // Output: Initial data
