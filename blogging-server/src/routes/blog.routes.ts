...
router.patch('/comment',RequestValidator.validate(CommentDTO),Authentication.Check(),catchAsync(iocBlogContainer.commentUpdate.bind(iocBlogContainer)))
router.delete('/delete/:commentID',Authentication.Check(),catchAsync(iocBlogContainer.commentDelete.bind(iocBlogContainer)))
router.get('/comment/:postID',Authentication.Check(),catchAsync(iocBlogContainer.getAllCommentByPostID.bind(iocBlogContainer)))
